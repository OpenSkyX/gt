    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-gradient-to-b from-slate-900 to-slate-950">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-bold text-slate-100 mb-3">创建账号</h1>
          <p className="text-sm text-slate-400">开始您的量化交易之旅</p>
        </div>
        ...
        <div className="glass-card rounded-2xl p-7 shadow-xl">
          <div className="space-y-5">
            ...
            <div>
              <label className="block text-sm font-medium text-slate-300 mb-2">
                邀请码<span className="text-slate-500 ml-1">(选填)</span>
              </label>
              <input
                type="text"
                value={inviteCode}
